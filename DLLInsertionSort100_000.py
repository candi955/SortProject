# Program for insertion sort on doubly linked list 100,000 random numbers
...
if __name__ == "__main__":
    ...
    for item in range(100000):
        randomNum = np.array(random.sample(range(1, 100001), 1))
    ...
    print(startRed + "\n\nTime duration of Insertion Sort, 100,000 random numbers, in seconds:\n" + endColor)
    print(duration100000)
