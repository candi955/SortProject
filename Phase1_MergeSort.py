...
class Main():
    ...
    print('Entering 100 numbers into the doubly linked list:\n', array100, '\n')

    # 1,000 random numbers
    array1_000 = np.array(random.sample(range(1, 1001), 1000))
    print('Entering 1,000 numbers into the doubly linked list:\n', array1_000, '\n')

    # 10,000 random numbers
    array10_000 = np.array(random.sample(range(1, 10001), 10000))
    print('Entering 10,000 numbers into the doubly linked list:\n', array10_000, '\n')

    # 100,000 random numbers
    array100_000 = np.array(random.sample(range(1, 100001), 100000))
    print('Entering 100,000 numbers into the doubly linked list:\n', array100_000, '\n')
