...
print("\n\n100,000 Random numbers in a linked list, sorted using the Timsort method:")
...
print(startRed + "\n\nTime duration of Timsort, 100,000 random numbers, in seconds:\n" + endColor)
